...
// Removed: interface MarketplaceProps { ... }

export function Marketplace({ user, posts, onViewDetail, onEdit, onDelete, onChat, chattingPostIds }) { // Removed type annotation for props
  ...
  // Apply filters
  const filterPosts = (postsToFilter) => { // Removed type annotation
...
// Removed: interface PostCardProps { ... }

function ModernPostCard({ post, isMyPost, onViewDetail, onEdit, onDelete, onChat, showAllActions, isChatting }) { // Removed type annotation for props
  const handleDelete = () => {
