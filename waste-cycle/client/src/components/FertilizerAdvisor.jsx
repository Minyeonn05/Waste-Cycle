...
// Removed: interface FertilizerAdvisorProps { ... }

export function FertilizerAdvisor({ defaultTab = 'recommendation', onTabChange }) { // Removed type annotation for props
  const [activeTab, setActiveTab] = useState(defaultTab);

  const handleTabChange = (tab) => { // Removed type annotation
    setActiveTab(tab);
    if (onTabChange) {
      onTabChange(tab);
    }
...
function NPKCalculatorContent() {
  ...
  const npkData = { // Removed type annotation
