...
// Removed: import type { User } from '../App';
// Removed: interface ProfilePageProps { ... }

export function ProfilePage({ user }) { // Removed type annotation for props
...
// Removed: interface Transaction { ... }

function TransactionCard({ transaction }) { // Removed type annotation for props
  return (
